...
Ported from pitwall/signalr_client.py — no runtime dependency on pitwall.
"""
...
class F1LiveClient:
    ...
    def get_all_state(self) -> dict[str, Any]:
        """Get the full current merged state across all topics."""
        return {t: self._state.get(t) for t in self._state.topics()}
